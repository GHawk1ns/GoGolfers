...
func (x QuotaScope) String() string {
	return proto1.EnumName(QuotaScope_name, int32(x))
}
func (x *QuotaScope) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(QuotaScope_value, data, "QuotaScope")
	if err != nil {
		return err
	}
	*x = QuotaScope(value)
...
func (x ThrottleType) String() string {
	return proto1.EnumName(ThrottleType_name, int32(x))
}
func (x *ThrottleType) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(ThrottleType_value, data, "ThrottleType")
	if err != nil {
		return err
	}
...
func (x QuotaType) String() string {
	return proto1.EnumName(QuotaType_name, int32(x))
}
func (x *QuotaType) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(QuotaType_value, data, "QuotaType")
	if err != nil {
		return err
	}
	*x = QuotaType(value)
...
func (m *TimedQuota) String() string { return proto1.CompactTextString(m) }
...
func (m *Throttle) String() string { return proto1.CompactTextString(m) }
...
func (m *ThrottleRequest) String() string { return proto1.CompactTextString(m) }
...
func (m *Quotas) String() string { return proto1.CompactTextString(m) }
...
func (m *QuotaUsage) String() string { return proto1.CompactTextString(m) }
func (*QuotaUsage) ProtoMessage()    {}

func init() {
	proto1.RegisterEnum("proto.QuotaScope", QuotaScope_name, QuotaScope_value)
	proto1.RegisterEnum("proto.ThrottleType", ThrottleType_name, ThrottleType_value)
	proto1.RegisterEnum("proto.QuotaType", QuotaType_name, QuotaType_value)
}
