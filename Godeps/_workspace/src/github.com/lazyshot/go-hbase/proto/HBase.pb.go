...
func (x TimeUnit) String() string {
	return proto1.EnumName(TimeUnit_name, int32(x))
}
func (x *TimeUnit) UnmarshalJSON(data []byte) error {
	value, err := proto1.UnmarshalJSONEnum(TimeUnit_value, data, "TimeUnit")
	if err != nil {
		return err
	}
	*x = TimeUnit(value)
...
func init() {
	...
	proto1.RegisterEnum("proto.TimeUnit", TimeUnit_name, TimeUnit_value)
